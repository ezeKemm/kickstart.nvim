  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        --
        defaults = {
          -- NOTE: I have no idea if this fucking works
          mappings = {
      ...
      vim.keymap.set('n', '<leader>ut', builtin.colorscheme, { desc = '[S]earch [U]i [T]heme' })
      ...
      vim.keymap.set('n', '<leader>vqf', builtin.quickfix, { desc = '[V]im [Q]uick [F]ix' })
      vim.keymap.set('n', '<leader>vqh', builtin.quickfix, { desc = '[V]im [Q]uick Fix [H]istory' })
      vim.keymap.set('n', '<leader>vl', builtin.loclist, { desc = '[V]im [L]ocation List' })
      ...
      -- Shortcut for searching your Neovim configuration filesident
    ...
    config = function(_, opts)
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- HACK: until we figure out mysterious keybinds -- this quick fix works
      ...
      capabilities = vim.tbl_deep_extend('force', capabilities, require('cmp_nvim_lsp').default_capabilities(), opts.capabilities or {})

      -- TODO: setup of config to use opts over config function
      -- moved servers to opts for easier config
      ...
      require('mason-lspconfig').setup {
        handlers = {
          function(server_name)
            ...
            -- added handling of additional setup in opts
            if opts.setup[server_name] then
              -- if setup returns true don't configure with lspconfig
              if opts.setup[server_name](server_name, server) then
                return
              end
            elseif opts.setup['*'] then
              -- use as fallback for any server
